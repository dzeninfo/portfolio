    ...
    (() => {
        ...
        class FullPage {
            ...
            styleCards() {
                for (let index = 0; index < this.sections.length; index++) {
                    const section = this.sections[index];
                    if (index >= this.activeSectionId) section.style.transform = "translate3D(0,0,0)"; else if (index < this.activeSectionId) {
                        section.style.transform = "translate3D(0,-100%, 0)";
                        section.style.opacity = "1";
                    }
                    if (index !== this.activeSectionId) section.style.opacity = "0";
                    if (index === this.activeSectionId) section.style.opacity = "1";
                }
            }
            styleFade() {
                for (let index = 0; index < this.sections.length; index++) {
