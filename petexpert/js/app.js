            ...
            constructor(options) {
                let config = {
                    ...
                    classes: {
                        ...
                        popupActive: "data-popup_show",
                        bodyActive: "data-popup-show"
                    },
                    focusCatch: true,
                    closeEsc: true,
                    bodyLock: true,
        ...
        function initSliders() {
            if (document.querySelector(".swiper")) {
                new core(".kind__slider", {
                    ...
                    navigation: {
                        prevEl: ".kind__swiper-button-prev",
                        nextEl: ".kind__swiper-button-next"
                    },
                    breakpoints: {
                        320: {
                            slidesPerView: 1,
        ...
        window.onload = function() {
            ...
            function documentActions(e) {
                ...
                if (window.innerWidth > 768 && isMobile.any()) {
                    if (targetElement.classList.contains("submenu__arrow")) targetElement.closest(".menu__item").classList.toggle("_hover");
